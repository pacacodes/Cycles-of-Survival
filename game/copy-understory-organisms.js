#!/usr/bin/env node
/**
 * Copies understory plants organism card PNGs from the working organisms output folder
...
function main() {
  ...
  console.log(`✅ Copied ${copiedCount}/${totalCategoryOrgs} understory plants organism cards`);
  if (missingCount > 0) {
