#!/usr/bin/env node
/**
 * Copies herbaceous plants organism card PNGs from the working organisms output folder
...
function main() {
  ...
  console.log(`✅ Copied ${copiedCount}/${totalCategoryOrgs} herbaceous plants organism cards`);
  if (missingCount > 0) {
