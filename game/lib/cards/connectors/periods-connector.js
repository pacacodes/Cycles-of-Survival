// Draw connector line and ring for periods badge to its field
module.exports = function drawPeriodsConnector(ctx, badgeX, badgeY, fieldX, fieldY, badgeRadius, scale, backgroundRightX, neonColor) {
  ctx.save();
