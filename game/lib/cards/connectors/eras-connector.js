// Draw connector line and ring for eras badge to its field
module.exports = function drawErasConnector(ctx, badgeX, badgeY, fieldX, fieldY, badgeRadius, scale, backgroundRightX, neonColor) {
  ctx.save();
  ...
  const shift = 18;
  const vertX = startX + outLen + shift - 27; // Move vertical segment 27px left
  const radius = 15;
