// Draw connector line and ring for trophic level badge to its field
module.exports = function drawTrophicLevelConnector(ctx, badgeX, badgeY, fieldX, fieldY, badgeRadius, scale, backgroundRightX, neonColor) {
  ctx.save();
  ...
  const shift = 18;
  const vertX = startX + outLen + shift - 10; // Move vertical segment 10px left
  const radius = 15;
