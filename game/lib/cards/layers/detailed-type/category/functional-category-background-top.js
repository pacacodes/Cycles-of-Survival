// Functional Category top background for split effect
module.exports = function drawFunctionalCategoryBackgroundTop(ctx, rx, ry, rw, rh, boxRadius, color, hexToRgba, opacity) {
  ctx.save();
  ctx.beginPath();
