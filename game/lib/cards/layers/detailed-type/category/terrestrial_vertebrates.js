...
const CATEGORY_NAME = 'Terrestrial Vertebrates (Amphibians & Reptiles)';
const LABEL = 'TRV';
const FILL = '#FFCC80';
const STROKE = '#EF6C00';
const TEXT = '#E65100';
...
if (require.main === module) {
  const outPath = process.argv[2] || path.resolve(process.cwd(), 'output/Category/terrestrial-vertebrates.png');
