...
const ROLE_DESC = {
  ...
  'scavenger':          'eats dead matter',
  'filter_feeder':      'filters food from water',
  'decomposer':         'breaks down dead matter',
  'detritivore':        'eats decomposing matter',
  'ecosystem_engineer': 'shapes habitat for others',
  'builder':            'builds physical structures',
  'mutualist':          'mutually benefits others',
  'parasite':           'feeds on a living host',
  'plague_swarm':       'mass outbreak organism',
};

const BIOME_DESC = {
  'Desert':     'arid, dry landscapes',
  'Farmland':   'cultivated farmland',
  'Floodplain': 'flood-prone river land',
  'Forest':     'tree-dominated ecosystem',
  'Freshwater': 'rivers, lakes & ponds',
  'Grassland':  'open plains & savannas',
  'Marine':     'open ocean & coasts',
  'Reef':       'coral & rocky reefs',
  'Taiga':      'boreal conifer forests',
  'Tundra':     'cold, treeless Arctic',
  'Urban':      'cities & built areas',
