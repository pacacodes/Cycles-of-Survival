// Trophic Level bottom background for split effect
module.exports = function drawTrophicLevelBackgroundBottom(ctx, rx, ry, rw, rh, boxRadius, color, hexToRgba, opacity) {
  ctx.save();
  ctx.beginPath();
