...
// Desulfovibrio vulgaris background renderer for Card 7
module.exports = async function desulfovibrioBackground(ctx, x, y, { width, height, corner, scale, roundedRectPath }) {
  ...
  // Overlay the Desulfovibrio vulgaris PNG
  const { loadImage } = require('canvas');
  const imgPath = path.resolve(__dirname, '../main-photo/Desulfovibrio vulgaris.png');
