#!/usr/bin/env node
/**
 * Copies ground-cover plants organism card PNGs from the working organisms output folder
...
function main() {
  ...
  console.log(`✅ Copied ${copiedCount}/${totalCategoryOrgs} ground-cover plants organism cards`);
  if (missingCount > 0) {
